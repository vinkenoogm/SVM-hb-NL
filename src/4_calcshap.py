...
def calc_shap(nback, sex, n=100):
    filename = '/home/vinkenoogm/SVM-NL/results/models'+foldersuffix+'/clf_' + str(nback) + '.sav'
    clf = pickle.load(open(filename, 'rb'))
    
    index = 0 if sex == 'men' else 1
    val = pd.read_pickle('/data1/vinkenoogm/scaled'+foldersuffix+'/'+str(sex)+'_'+str(nback)+'_test.pkl')
    clf_s = clf[index]
    ...
    path = '/home/vinkenoogm/SVM-NL/results/shap'+foldersuffix+'/'
